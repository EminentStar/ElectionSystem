...
<link rel="stylesheet" type="text/css" href="<spring:url value="/css/view/voteerror.css"/>"/>
</head>
<body class="color">
<jsp:include page="/WEB-INF/view/top.jsp" />
 
 
<div class="not_service" style="background-color: #DA8D95; color: #DA8D95;"><span style="color: #DA8D95"></span>
